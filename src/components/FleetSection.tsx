        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative w-full rounded-[24px] overflow-hidden shadow-2xl group bg-mb-navy">
            ...
            <img 
              ...
              onError={(e) => {
                ...
                target.parentElement?.classList.add('flex', 'items-center', 'justify-center', 'bg-mb-navy-dark');
                if (target.parentElement) {
                   target.parentElement.innerHTML = '<span class="text-white font-heading text-2xl opacity-30">Flotillas y Prevención</span>';
                }
              }}
            />
          </div>
          ...
          <div ref={contentRef} className="max-w-2xl">
            ...
            <a 
              ...
              className="inline-flex bg-mb-navy hover:bg-mb-navy-dark text-white px-8 py-4 rounded-[14px] items-center justify-center gap-3 transition-colors font-ui text-lg tracking-wide uppercase shadow-lg shadow-mb-navy/20"
            >
              <Phone size={20} /> Solicitar revisión
            </a>
          </div>
        </div>
      </div>
